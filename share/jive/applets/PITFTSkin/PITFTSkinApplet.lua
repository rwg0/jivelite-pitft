...
applets.PITFTSkin.PITFTSkinApplet
...
local log                    = require("jive.utils.log").logger("applet.PITFTSkin")
...
local imgpath = "applets/PITFTSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/PITFTSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/PITFTSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
